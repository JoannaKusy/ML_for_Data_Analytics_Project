...
st.set_page_config(page_title="Live Energy Forecast", layout="wide", initial_sidebar_state="collapsed")
...
st.markdown(
    ...
    .block-container {
        padding-top: 1.5rem !important; /* Gave the top some breathing room */
        padding-bottom: 0rem !important;
        padding-left: 1rem !important;
        padding-right: 1rem !important;
        max-width: 100% !important;
    }
    /* 2. Hide the default Streamlit header and footer */
    header {visibility: hidden;}
    footer {visibility: hidden;}
    
    /* 3. Keep the Left Column KPI Metrics compact */
        ...
        "series": [
            {
                ...
                "symbolSize": 110, 
                "label": {
                    "show": True, "color": "#fff", "position": "inside", 
                    "fontSize": 18, 
                    "align": "center",
                    "formatter": "{b}" 
                },
                "data": [
                    {
                        ...
                        "value": [10, 50], 
                        "symbolSize": 135, 
                        "itemStyle": {"color": "transparent", "borderColor": "#00E676", "borderWidth": 5}
                    },
                    {
                        "name": f"🌡🏠\n{heat_pump:.2f} kW\nHeat Pump", 
                        "value": [70, 50],
                        "itemStyle": {"color": "transparent", "borderColor": "#FF7043", "borderWidth": 4}
                    },
                    {
                        "name": f"🫧👕\n{wash:.2f} kW\nWasher",
                        "value": [85, 100], 
                        "itemStyle": {"color": "transparent", "borderColor": "#4285F4", "borderWidth": 4}
                    },
                    {
                        "name": f"🔌🔋\n{other:.2f} kW\nOther",
                        "value": [85, 0], 
                        "itemStyle": {"color": "transparent", "borderColor": "#AB47BC", "borderWidth": 4}
                    }
                ],
            },
            {
                "type": "lines", "coordinateSystem": "cartesian2d",
                "effect": {"show": True, "period": 1.5, "trailLength": 0.05, "color": "#fff", "symbolSize": 8},
...
if start_stream:
    ...
    for index in range(len(X_past_test)):
        ...
        line_chart_placeholder.line_chart(df_chart, color=["#1f77b4", "#00E676"], height=250) 
